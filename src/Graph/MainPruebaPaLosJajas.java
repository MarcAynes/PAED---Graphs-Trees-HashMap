...
public class MainPruebaPaLosJajas {
    public static void main(String[] args) {
        ...
        String [] strings_2 =  {"El gitano de las 3000","ErPepe"};
        users[2] = new User ("Dani, el agresivo de Sevilla",100,strings_2);
        ...
        users[5] = new User ("El gitano de las 3000",99,strings_5);
        String [] strings_6 =  {"El paio cura","Sinmerk, el robot del futuro"};
        users[6] = new User ("Willy Wonka y la fabrica de ANDs", 87,strings_6);
        String [] strings_7 =  {"El paio cura","El gitano de Gomaespuma"};
        users[7] = new User ("El gitano de Gomaespuma", 77,strings_7);
        String [] strings_8 =  {"El gitano de las 3000","ErPepe","Sinmerk, el robot del futuro"};
        users[8] = new User ("Sinmerk, el robot del futuro",56,strings_8);
        String [] strings_9 =  {"Dani, el agresivo de Sevilla","El compi de compus imaginario","Sinmerk, el robot del futuro","El gitano de las 3000"};
